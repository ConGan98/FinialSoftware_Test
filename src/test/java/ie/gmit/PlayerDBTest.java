...
public class PlayerDBTest {
    ...
    @Test
    void addEmployee() {
        players p1 = new players("conor ", "kenny", "conork@gmail", "1234567890", 121, "loughrea");
    ...
    void addEmployeeDup(){
        ...
        NewList = new PlayerDB();
        players p2 = new players("Conor","kenny","conork@gmail","1234567890",121,"loughrea");
    ...
    void removePlayer(){
        ...
        players p4 = new players("Conor","kenny","conork@gmail","1234567890",121,"loughrea");
        NewList = new PlayerDB();
